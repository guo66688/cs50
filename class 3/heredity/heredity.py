    ...
    for person , attributes in people.items():
        ...
        if mother is None and father is None:
            ...
            if num_genes == 2:
                ...
                gene_prob = (passing_probs[mother] * (1-passing_probs[father])) + ((1-passing_probs[mother]) * passing_probs[father])
            else:
                gene_prob = (1-passing_probs[father]) * (1-passing_probs[mother]) 

        trait_prob = PROBS["trait"][num_genes][person in have_trait]

        probability *= trait_prob * gene_prob
